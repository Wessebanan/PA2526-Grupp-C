...
//
//
//	EXPECT_EQ(d_test.LoadImageToBitmap("PepeLaugh.jfif", hehe) , !nullptr);
//}
//
...
//	char hehe[10] = "pepe";
//	d_test.CreateHwndRenderTarget(window_handle, &rect_test);
//	d_test.LoadImageToBitmap("PepeLaugh.jfif", hehe);
...
//	d_test.LoadImageToBitmap("PepeLaugh", hehe);
//
//
//	EXPECT_NE(d_test.LoadImageToBitmap("PepeLaugh", hehe), nullptr);
//}
//
...
//	char hehe[10] = "pepe";
//	d_test.CreateHwndRenderTarget(window_handle, &rectTest);
//	d_test.LoadImageToBitmap("fdjak", hehe);
