...
bool Sphere::Intersects(Cylinder& cylinder)
{
...
bool OBB::Intersects(Cylinder& cylinder)
{
	return cylinder.Intersects(this);
}
...
bool AABB::Intersects(Cylinder& cylinder)
{
	return cylinder.Intersects(this);
}
...
bool Cylinder::Intersects(BoundingVolume* other)
{
	...
	if (obb)
	{
		return Intersects(*(BoundingOrientedBox*)obb);
	}
	AABB* aabb = dynamic_cast<AABB*>(other);
	if (aabb)
	{
		return Intersects(*(BoundingBox*)aabb);
	}
	Sphere* sphere = dynamic_cast<Sphere*>(other);
	if (sphere)
	{
		return Intersects(*(Sphere*)sphere);
	}
	Cylinder* cylinder = dynamic_cast<Cylinder*>(other);
	if (cylinder)
	{
...
bool Cylinder::Intersects(BoundingBox& aabb)
{
...
bool Cylinder::Intersects(BoundingSphere& sphere)
{
...
bool Cylinder::Intersects(BoundingOrientedBox& obb)
{
...
bool Cylinder::Intersects(Cylinder& cylinder)
{
