...
void InitParticles(ecs::EntityComponentSystem& rECS)
{
	...
	rECS.reserveComponentCount<ecs::components::FireParticleComponent>(ECS_MAXIMUM_SPLASH_PARTICLES);
	...
	*/
	...
	rECS.createSystem<ecs::systems::FireSpawnerSystem>(7);
	...
	*/
	...
	rECS.createSystem<ecs::systems::FireUpdateSystem>(8);
}