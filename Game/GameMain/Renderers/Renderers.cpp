...
#pragma region SceneObjectRenderSystem
		...
		void SceneObjectRenderSystem::Initialize(graphics::RenderManager* pRenderMgr, graphics::RenderBuffer* pRenderBuffer)
		{
			...
			*/
			mMeshMap[SCENE_OBJECT::SNOWMAN] =	MESH_TYPE::MESH_TYPE_SNOWMAN;
			mMeshMap[SCENE_OBJECT::ANGEL] =		MESH_TYPE::MESH_TYPE_ANGEL;
			mMeshMap[SCENE_OBJECT::IGLOO] =		MESH_TYPE::MESH_TYPE_IGLOO;
			mMeshMap[SCENE_OBJECT::CLIFF] =		MESH_TYPE::MESH_TYPE_CLIFF;
			mMeshMap[SCENE_OBJECT::ROCKS] =		MESH_TYPE::MESH_TYPE_ROCKS;
			mMeshMap[SCENE_OBJECT::CAMP] =		MESH_TYPE::MESH_TYPE_CAMP;
			mMeshMap[SCENE_OBJECT::TREES] =		MESH_TYPE::MESH_TYPE_TREES;
			mMeshMap[SCENE_OBJECT::FLOWERS] =	MESH_TYPE::MESH_TYPE_FLOWERS;
			mMeshMap[SCENE_OBJECT::VILAGE] =	MESH_TYPE::MESH_TYPE_VILAGE;
			mMeshMap[SCENE_OBJECT::SANDSTONE] = MESH_TYPE::MESH_TYPE_SANDSTONE;
			mMeshMap[SCENE_OBJECT::PALMS] =		MESH_TYPE::MESH_TYPE_PALMS;
			mMeshMap[SCENE_OBJECT::PYRAMIDS] =	MESH_TYPE::MESH_TYPE_PYRAMIDS;
